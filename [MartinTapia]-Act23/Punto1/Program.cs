    ...
    */
    ...
    internal class ServidorImpresion
    {
        ...
        public void ImprimirSiguiente()
        {
            ...
            for (int i = 0; i < documentos.Count; i++)
            {
                ...
                if (vacia == false)
                {
                    ...
                    Console.WriteLine("Cantidad Paginas: " + documentos[0].CantidadPaginas);
        ...
        public void MostrarColaPendiente()
        {
            ...
            for (int i = 0; i < documentos.Count; i++)
            {
                cantPags = documentos[i].CantidadPaginas + cantPags;

                if (documentos.Count > 0)
                {
                    Console.WriteLine("====================================");
                    Console.WriteLine("Nombre del Archivo: " + documentos[i].NombreArchivo);
                    Console.WriteLine("Cantidad Paginas: " + documentos[i].CantidadPaginas);
                }
                if (documentos.Count == 0)
                {
            ...
            Console.WriteLine("QUEDAN " + cantPags + " EN TOTAL PARA IMPRIMIR.");
            Console.ForegroundColor = ConsoleColor.White;
        }
    }
